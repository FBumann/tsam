...
class ClusteringResult:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if self.timestep_duration is not None:
            result["resolution"] = self.timestep_duration
    ...
    def from_dict(cls, data: dict) -> ClusteringResult:
        ...
        if "resolution" in data:
            kwargs["timestep_duration"] = data["resolution"]
        # Reference fields
    ...
    def apply(
        ...
        *,
        ...
        old_params = _build_old_params(
            ...
            predef_cluster_order=self.cluster_assignments,
            predef_cluster_centers=self.cluster_centers,
            predef_segment_order=self.segment_assignments,
